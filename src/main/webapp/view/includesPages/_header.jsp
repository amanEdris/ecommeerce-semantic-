        ...
        <div class="col-sm-12">
          <div class="toprow">
            <ul class="links">
              ...
              <li class="first">
                <a class="active" href="/UniqueBookApp">
                  <i class="fa fa-home"></i>Home</a>
              </li>
              <c:if test="${!empty User}">
                <li>
                  <a class="" href="/UniqueBookApp/account?action=edit&data=show">
                    <i class="fa fa-user"></i>My Account</a>
                </li>
              </c:if>

              <li>
                <a class="" href="/UniqueBookApp/viewCart">
                  <i class="fa fa-shopping-cart"></i>Shopping Cart</a>
              </li>
              <c:if test="${!empty cart}">
                <li>
                  <a class="" href="/UniqueBookApp/order?action=checkout">
              ...
              <c:if test="${empty User}">
                ...
                <li class="login_h last">
                  <a href="/UniqueBookApp/account?action=login&type=show">
                    <i class="fa fa-lock"></i>Login</a>
                </li>
              </c:if>
              <c:if test="${!empty User}">
                <li class="login_h last">
                  <a href="/UniqueBookApp/account?action=logout">
                            ...
                            <tr class="first">
                              <td class="image">
                                <a href="/UniqueBookApp/book?action=show&productNo=<c:out value=" ${product.productNumber}" />&category=<c:out value=" ${category}"/>">
                                  <img src="${product.imagepath}" alt="${product.productName}" title="${product.productName}"></a>
                                </td>
                                <td class="name">
    ...
    <div class="top_color">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            ...
            <div id="logo">
              <a href="#home">
                <img src="./image/logo-copy.png" title="uniquebooks" alt="Uniquebooks"></a>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="toprow-1">
              <a class="swipe-control" href="#test">
          ...
          <div class="col-sm-12">
            ...
            <div id="menu-gadget">
              ...
              <ul id="nav" class="sf-menu-phone">
                <li class="parent">
                  <a href="/UniqueBookApp/book?action=listBooks&category=Fiction">Fiction</a>
                  <ul>
                    <li>
                    ...
                    <li class="parent">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="/UniqueBookApp/book?action=listBooks&category=Poetry">Poetry
                          </a>
                        </li>
                        <li>
                          <a href="/UniqueBookApp/book?action=listBooks&category=Romance">Romance
                          </a>
                        </li>
                      </ul>
                      <i class="fa fa-angle-down"></i>
                    ...
                    <li>
                      <a href="/book?action=listBooks&category=Biography">Biography</a>
                    </li>
                    <li>
                      <a href="/UniqueBookApp/book?action=listBooks&category=Health Fitness">Health Fitness</a>
                    </li>
                    <li>
                      <a href="/UniqueBookApp/book?action=listBooks&category=Cook Books">Cook Books</a>
                    </li>
                    <li>
                ...
                <div id="menu" class="">
                  ...
                  <ul class="sf-menu">
                      ...
                      <div class="sf-mega" style="display: none;">
                        <ul class="sf-mega-section">
                          <c:forEach items="${fictionalCategory}" var="fiction">
                            <li>
                              <a class="screenshot1" href="/UniqueBookApp/book?action=listBooks&category=${fiction.name}">${fiction.name}</a>
                            </li>
                          </c:forEach>
                    ...
                    <li class="cat_1">
                      <a href="/UniqueBookApp/book?action=listBooks&category=Non Fiction" class="">Non Fiction</a>
                      <div class="sf-mega" style="display: none;">
                        <ul class="sf-mega-section">
                          <c:forEach items="${nonfictionCategory}" var="nonfiction">
                            <li>
                              <a class="screenshot1" href="/UniqueBookApp/book?action=listBooks&category=${nonfiction.name}">${nonfiction.name}</a>
                            </li>
                          </c:forEach>
                        </ul>
                      </div>
                    ...
                    <li class="cat_1">
                      <a href="/UniqueBookApp/book?action=listBooks&category=Kids Book" class="">Kids Book</a>
                      <div class="sf-mega" style="display: none;">
                        <ul class="sf-mega-section">
                          <c:forEach items="${kidsCategory}" var="kidsbook">
                            <li>
                              <a class="screenshot1" href="/UniqueBookApp/book?action=listBooks&category=${kidsbook.name}">${kidsbook.name}</a>
                            </li>
                          </c:forEach>
                        </ul>
                      </div>
