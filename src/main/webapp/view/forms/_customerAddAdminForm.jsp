...
<c:if  test="${empty User}">
    ...
    <form class="form-horizontal" action="addCustomer" method="post"  id="register" role="form">
    </c:if>
    <c:if  test="${!empty User}">
        <form class="form-horizontal" action="updateCustomer" method="post"  id="register" role="form">  
        </c:if>
            ...
            <div class="form-group">  
                ...
                <label>* Address:</label>
                <input class="form-control" type="text" name="address_1" value="${location.address}">
                <input class="form-control" type="hidden" name="customerId" value="${User.customerId}">
            </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="postcode" value="${location.postalCode}">
            </div>
